...
router.get('/accountManager', apiaccountManagerController.get);
router.post('/accountManager', apiaccountManagerController.post);
router.put('/accountManager', apiaccountManagerController.put);

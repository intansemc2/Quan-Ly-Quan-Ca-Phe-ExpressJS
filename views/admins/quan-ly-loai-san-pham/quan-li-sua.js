...
#modelSuaLoaiSanPham.modal.fade(tabindex='-1', role='dialog', aria-labelledby='ModelSuaLoaiSanPham aria-labelledby', aria-hidden='true')
    .modal-dialog.modal-dialog-centered(role='document')
        form.modal-content
            .modal-header
                h5.modal-title Sửa loại sản phẩm 
                button.close(type='button', data-dismiss='modal', aria-label='Close')
                    span(aria-hidden='true') &times;
            .modal-body                
                .alerts
                    // Các alert của phần này
                input.idLoaiSanPham(type='hidden')
            ...
            .modal-footer
                input.confirm.btn.btn-outline-secondary.rounded-0(type='button', value='Sửa Loại sản phẩm')

                    ...
                    .container-fluid
                        ...
                        .card
                            .card-header
                                ...
                                | Các thao tác chung
                            .card-body
                                button.btn.btn-outline-secondary.rounded-0(type='button', data-toggle='modal', data-target='#modelThemKhachHang') Thêm mới  
                                span.mx-1
                        ...
                        include quan-ly-khach-hang/quan-ly-them
    
                        // Model sửa khách hàng
                        include quan-ly-khach-hang/quan-ly-sua
                        ...
                        .card.my-4
                            ...
                            .card-body
                                #tableQuanLyKhachHangContainer.table-responsive
                                    table#tableQuanLyKhachHang.table.table-bordered.table-striped.table-hover(width='100%', cellspacing='0')
                                        thead
                                            tr
                                                th Id khách hàng
                                                th Tên
    ...
    block custom_javascripts
        ...
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/variables.js")
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/table-functions.js")
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/them.js")
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/sua.js")
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/xoa.js")
        script(type="text/javascript", src="/javascripts/admins/quan-ly-khach-hang/main.js")
